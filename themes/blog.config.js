...
const BLOG = {
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '心流创作, 自我输出', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '754629011@qq.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  COMMENT_UTTERRANCES_REPO:
      process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO 'yanqinyi/NotionNext' // 你的代码仓库名， 例如我是 'tangly1024/NotionNext'； 更多文档参考 https://utteranc.es/
  ...
  COMMENT_VALINE_PLACEHOLDER:
      process.env.NEXT_PUBLIC_VALINE_PLACEHOLDER || '上座!~', // 可以搭配后台管理评论 https://github.com/DesertsP/Valine-Admin  便于查看评论，以及邮件通知，垃圾评论过滤等功能

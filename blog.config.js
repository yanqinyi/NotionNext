...
const BLOG = {
  ...
  NOTION_PAGE_ID:
      process.env.NOTION_PAGE_ID || '7493a2fd882c425a9de2eb5216cefc4b',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是秦毅，欢迎来到我的电子岛屿🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '秦毅', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '心灵闪耀，伟大真诚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://qinyi.org/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '心流输出,自我创造', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  //  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '', // 邮箱地址 例如mail@tangly1024.com
  //  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  //  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/yanqinyi', // 你的github个人主页 例如 https://github.com/tangly1024
  //  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '', // 你的telegram 地址 例如 https://t.me/tangly_1024
   // CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || '', // 你的linkedIn 首页
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || 'tiki.new', // 您的instagram地址
  ...
  // 音乐播放插件
  <iframe frameborder="no" border="0" marginwidth="0" marginheight="0" width=330 height=86 src="//music.163.com/outchain/player?type=2&id=28768123&auto=1&height=66"></iframe>
  ...
  COMMENT_UTTERRANCES_REPO:
      process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || 'yanqinyi/comment-use', // 你的代码仓库名， 例如我是 'tangly1024/NotionNext'； 更多文档参考 https://utteranc.es/

  // giscus @see https://giscus.app/
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'yanqinyi/comment-use', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  ...
  COMMENT_VALINE_PLACEHOLDER:
      process.env.NEXT_PUBLIC_VALINE_PLACEHOLDER || '跟秦毅唠唠嗑', // 可以搭配后台管理评论 https://github.com/DesertsP/Valine-Admin  便于查看评论，以及邮件通知，垃圾评论过滤等功能
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '达咩2', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
      process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || './bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
      process.env.NEXT_PUBLIC_DESCRIPTION || '达咩1', // 站点描述，被notion中的页面描述覆盖

  // 网站图片
  IMG_URL_TYPE: process.env.NEXT_PUBLIC_IMG_TYPE || '达咩3', // 此配置已失效，请勿使用；AMAZON方案不再支持，仅支持Notion方案。 ['Notion','AMAZON'] 站点图片前缀 默认 Notion:(https://notion.so/images/xx) ， AMAZON(https://s3.us-west-2.amazonaws.com/xxx)
